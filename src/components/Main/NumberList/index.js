...
const NumberList = () => {
  ...
  return (
    <div className="relative">
      <div className="fixed left-0 top-0 h-full max-h-[83vh] w-[70px] transition-width duration-300 bg-gray-100 flex flex-col justify-start mt-[76px] z-10 p-2 overflow-scroll">
